...
Here you can see a table of associations
...
```
Looks like one point is way off, and this is a limitation of my model-- model fits pretty well except at the really small values of arsenic, and number of people who switchedd was smaller than expected at these values.
...
if inc dist 10 meters, for people less than 6 yrs education, the odds of switching go down by .88 (88% what were)

if inc dist 10 meters, for people more than 6 yrs education, the odds of switching go down by .95 (96% what were)
